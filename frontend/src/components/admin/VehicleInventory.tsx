                    ...
                    <TableRow key={vehicle.id}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          {vehicle.images?.[0] && (
                            <img
                              src={typeof vehicle.images[0] === 'string' && vehicle.images[0].startsWith('http') ? vehicle.images[0] : `${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:3002'}${vehicle.images[0]}`}
                              alt=""
