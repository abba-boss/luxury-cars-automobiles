  ...
  "inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        verified: "border-emerald-500/30 bg-emerald-500/20 text-emerald-400",
        hot: "border-primary/30 bg-primary/20 text-primary",
        new: "border-blue-500/30 bg-blue-500/20 text-blue-400",
        premium: "border-amber-500/30 bg-amber-500/20 text-amber-400",
