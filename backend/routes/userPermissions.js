...
router.post('/users/:userId/permissions', async (req, res, next) => {
  try {
    const { userId } = req.params;
...
router.put('/users/:userId/permissions/:permissionId', async (req, res, next) => {
  try {
    const { userId, permissionId } = req.params;
...
router.get('/users-with-permissions', async (req, res, next) => {
  try {
...
router.get('/users/:userId/check-permission', async (req, res, next) => {
  try {
    const { userId } = req.params;
